    ...
    <div className="w-full min-h-screen min-h-[100dvh] flex justify-center items-center bg-gradient-to-br from-black via-gray-900 to-black relative overflow-x-hidden animate-fade-in px-4 sm:px-6 py-6 safe-all">
      ...
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg relative z-10">
        <CardHeader className="pb-2 px-0">
          ...
          <CardDescription className="text-orange-400 text-center pt-2 text-sm sm:text-base">
        ...
        <CardContent className="space-y-4 sm:space-y-6 pt-4 px-0">
          ...
          <div className="space-y-2">
            <Label htmlFor="roomName" className="text-xs sm:text-sm font-medium text-gray-400 flex items-center gap-2">
            ...
            <Input
              ...
              className="w-full bg-gray-800 text-white border-gray-700 focus:ring-orange-500 focus:ring-opacity-50 min-h-[44px] text-sm sm:text-base"
            />
          </div>
