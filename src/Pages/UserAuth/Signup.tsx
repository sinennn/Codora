...
const inputField =
  'w-full p-3 min-h-[44px] rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-400/50 transition-all duration-300 text-sm sm:text-base';
      ...
      >
        <motion.div className="relative" variants={childVariants}>
          ...
          <motion.img
            src={Start}
            alt="Codora Owl"
            className="w-24 h-40 sm:w-[120px] sm:h-[200px] object-contain"
        ...
        <motion.h1
          className="text-white text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-center"
        ...
        >
          ...
          <motion.div className="relative w-full">
            <LockKeyhole className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 sm:w-5 sm:h-5" />
            <motion.input
              type="password"
          ...
          <motion.button
            className="w-full p-3 min-h-[44px] rounded-lg bg-orange-500 text-white font-bold hover:bg-orange-600 hover:shadow-lg shadow-orange-500/30 transition-all duration-300 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
